...
export default function GraficoEstadisticasVehiculos() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
      ...
      {/* Línea temporal */}
      <section className="bg-white rounded-lg shadow-md p-6">
        <h3 className="text-lg font-semibold text-blue-700 mb-4 text-center">Entregas por fecha</h3>
